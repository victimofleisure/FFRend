...
/*
		...
		02		28oct08	fix missing type specifier warning in DoModal
		03		29oct08	add folder arg to ctor
		04		06jan10	W64: DoModal return value is 64-bit
...
CMultiFileDlg::CMultiFileDlg(BOOL bOpenFileDialog, LPCTSTR lpszDefExt,
