...
/*
		...
		01		29jul06	derive from CEditSliderCtrl, remove undo and custom draw
		02		22nov06	add undo
		03		23apr10	remove undo again
		04		27may10	add HScroll
...
class CSelectSliderCtrl : public CEditSliderCtrl
{
	DECLARE_DYNAMIC(CSelectSliderCtrl);
public:
// Construction
	CSelectSliderCtrl();
